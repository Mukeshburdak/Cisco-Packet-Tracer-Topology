...
This experiment focuses on assigning IP addresses through subnetting, configuring network devices 
(such as routers, switches, and PCs), and testing connectivity between subnets using ping or 
traceroute commands. By the end of this experiment, learners will be able to: 

• Perform subnet calculations for a given IP range. 

• Assign appropriate IP addresses and subnet masks. 

• Configure devices according to subnet plans. 
...
o Mask: 255.255.255.252 

o Gateway: 192.168.10.33 
